          ...
          <View style={this.styles.rowButton}>
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                const participant = this.state.participantString.replace(/ /g, "").split(",")

                if (!this.state.isGroup && participant.length > 1) {
                  Alert.alert("1:1 conversation cannot have more than 2 participant")
                  return
                }
                this.hide()
