...
import ActShtCreateConversation from "./StringeeChat/ActShtCreateConversation"
import ActShtGetConversation from "./StringeeChat/ActShtGetConversation"
import ActShtParticipant from "./StringeeChat/ActShtParticipant"
import ActShtUpdateConversation from "./StringeeChat/ActShtUpdateConversation"
import ActShtSendMsg from "./StringeeChat/ActShtSendMsg"
import ActShtGetMessage from "./StringeeChat/ActShtGetMessage"
import ActShtMsgAction from "./StringeeChat/ActShtMsgAction"
import ActShtGetUserInfo from "./StringeeChat/ActShtGetUserInfo"
import ActShtUpdateUserInfo from "./StringeeChat/ActShtUpdateUserInfo"
...
export default class ChatScreen extends Component {
  ...
  getConversationById = (convId) => {
    this.client.current.getConversationById(convId, (status, code, message, conversation) => {
      console.log(
  ...
  getConversationWithUser = (userId) => {
    this.client.current.getConversationWithUser(userId, (status, code, message, conversation) => {
      console.log(
  ...
  getUnreadConversationCount = () => {
    this.client.current.getUnreadConversationCount((status, code, message, count) => {
  ...
  getUserInfo = (userIds) => {
    this.client.current.getUserInfo(userIds, (status, code, message, users) => {
      console.log("Get user info: " + message + " \nusers -" + JSON.stringify(users))
      this.addLog("Get user info: " + message + " \nusers -" + JSON.stringify(users))
    })
  }

  updateUserInfo = (userInfo) => {
    this.client.current.updateUserInfoWithParam(userInfo, (status, code, message) => {
  ...
  deleteConversation = () => {
    this.client.current.deleteConversation(this.state.selectedConv.id, (status, code, message) => {
    ...
    if (this.state.selectedConv.isGroup) {
      this.client.current.addParticipants(
        ...
        (status, code, message, users) => {
          console.log("Add participants: " + message + "\nusers - " + JSON.stringify(users))
          this.addConversationLog(
  ...
  removeParticipants = (participants) => {
    if (this.state.selectedConv.isGroup) {
      this.client.current.removeParticipants(
        ...
        participants,
        (status, code, message, users) => {
          console.log("Remove participants: " + message + "\nusers - " + JSON.stringify(users))
          this.addConversationLog(
            "Remove participants: " + message + "\nusers - " + JSON.stringify(users),
          )
        },
      )
    }
  ...
  sendBeginTyping = () => {
    this.client.current.sendBeginTyping(this.state.selectedConv.id, (status, code, message) => {
  ...
  sendEndTyping = () => {
    this.client.current.sendEndTyping(this.state.selectedConv.id, (status, code, message) => {
  ...
  getLocalMessages = () => {
    ...
    this.client.current.getLocalMessages(
      ...
      (status, code, message, messages) => {
        console.log("Get local messages: " + message + "\nmessages - " + JSON.stringify(messages))
  ...
  getLastMessages = () => {
    ...
    this.client.current.getLastMessages(
      ...
      (status, code, message, messages) => {
        console.log("Get last messages: " + message + "\nmessages - " + JSON.stringify(messages))
  ...
  getMessagesBefore = (sequence) => {
    ...
    this.client.current.getMessagesBefore(
      ...
      loadDeletedMessageContent,
      (status, code, message, messages) => {
        console.log("Get messages before: " + message + "\nmessages - " + JSON.stringify(messages))
          ...
          <ScrollView>
            <View style={this.styles.container}>
              ...
              <View style={this.styles.rowButton}>
                ...
                >
                  <Text style={this.styles.text}>Get conversation with user</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={this.styles.button}
                  onPress={() => {
                ...
                >
                  <Text style={this.styles.text}>Get unread conversations count</Text>
                </TouchableOpacity>
              </View>
              <View style={this.styles.rowButton}>
                <TouchableOpacity
        ...
        >
          <SafeAreaView style={this.styles.container}>
            <View style={this.styles.header}>
              ...
              >
                <Icon icon="back" color="#ffffff" />
              </TouchableOpacity>
              <Text style={this.styles.headerTitle}>
                {this.state.selectedConv === undefined ? "" : this.state.selectedConv.id}
              </Text>
            </View>
              ...
              <ScrollView>
                <View style={this.styles.container}>
                  ...
                  <View style={this.styles.rowButton}>
                    ...
                    >
                      <Text style={this.styles.text}>Mark conversation as read</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </ScrollView>
