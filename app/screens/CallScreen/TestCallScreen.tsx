...
class TestCallScreen extends Component {
  state = {
  ...
  answerCallAction = () => {
    ...
    this.refs.stringeeCall.answer(this.state.syncCall.callId, (status, code, message) => {
    ...
    RNCallKeep.addEventListener(
      ...
      ({ error, callUUID, handle, localizedCallerName, hasVideo, fromPushKit, payload }) => {
        ...
        if (this.state.fakeCallIds.includes(callUUID)) {
          ...
          this.setState({ fakeCallIds: newFakeCallIds })
          console.log(
            "END FAKE CALL, UUID: " + callUUID + " fakeCallIds: " + this.state.fakeCallIds.toString,
          )
        }
    ...
    RNCallKeep.addEventListener("endCall", ({ callUUID }) => {
      ...
      if (
        ...
        if (this.state.answeredCall) {
          ...
          this.refs.stringeeCall.hangup(this.state.syncCall.callId, (status, code, message) => {
          ...
          this.refs.stringeeCall.reject(this.state.syncCall.callId, (status, code, message) => {
  ...
  _switchCameraAction = () => {
    ...
    this.refs.stringeeCall.switchCamera(this.state.syncCall.callId, (status, code, message) => {
      console.log(message)
    })
  }
